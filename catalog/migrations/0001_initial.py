    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('summary', models.TextField(help_text='Enter a brief description of the book!1', max_length=1000)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(help_text='Enter Genre e.g Programming, Fictional...', max_length=200)),
            ],
        ),
        migrations.CreateModel(
            name='BookInstance',
            fields=[
                ('id', models.UUIDField(default=uuid.uuid4, help_text='Set unique text for BookInstance', primary_key=True, serialize=False)),
                ('imprint', models.CharField(max_length=200)),
                ('due_finish', models.DateField(blank=True, null=True)),
